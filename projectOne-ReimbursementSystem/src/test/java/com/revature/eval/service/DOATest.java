...
/**
 * This Junit test does require the user to be aware of the state of data in the test database
 * in order to properly configure many of the test cases.
 * @author jeremiah
 *
 */
public class DOATest {
	...
	@Test
	public void testCreateEmployee() throws IOException, SQLException {
		/*
